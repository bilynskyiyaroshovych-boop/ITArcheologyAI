...
class DragDropLabel(QLabel):
    def __init__(self, parent_tab):
        ...
        self.setText(
            "<b>Drag Image Here</b><br>"
            "<span style='font-size:12px; color:#888'>or use the Browse button</span>"
        )
...
class PredictTab(QWidget):
    ...
    def init_ui(self):
        ...
        self.path_input.returnPressed.connect(
            lambda: self.load_image(self.path_input.text())
        )
    ...
    def run_prediction(self):
        ...
        try:
            ...
            conf_color = (
                "#27ae60" if conf > 0.7 else "#e67e22" if conf > 0.4 else "#c0392b"
            )
